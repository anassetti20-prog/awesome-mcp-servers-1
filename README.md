...
- **[x402-mcp-server](http://178.105.35.170:8080)** - Pay-per-use MCP server with 53+ AI/utility services via USDC micropayments on Base. Includes AI search, web scraping, sandboxed code execution, deep research, halal crypto screening, URL-to-MCP bridge, and automated marketing. Self-hosted, Halal-compliant.
